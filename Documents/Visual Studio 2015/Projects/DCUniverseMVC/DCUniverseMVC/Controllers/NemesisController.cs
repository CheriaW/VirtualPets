...
namespace DCUniverseMVC.Controllers
{
    public class NemesisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NemisisID,NemisisName,NemesisInJail,NumberOfHenchman,HeroID")] Nemesi nemesi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NemisisID,NemisisName,NemesisInJail,NumberOfHenchman,HeroID")] Nemesi nemesi)
        {
            if (ModelState.IsValid)
            {

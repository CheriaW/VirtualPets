...
namespace DCUniverseMVC.Controllers
{
    public class VillainsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VillainID,VillainName,VillainPowerLevel,VillainInJail")] Villain villain)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VillainID,VillainName,VillainPowerLevel,VillainInJail")] Villain villain)
        {
            if (ModelState.IsValid)
            {
